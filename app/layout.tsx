// app/layout.tsx - FUSIÓN TOTAL SIN OMISIONES (RESTAURADO)
...
// 🔥 CONFIGURACIÓN DE VIEWPORT (IPHONE & ANDROID FIX)
...
// 🔥 GENERACIÓN DE METADATA DINÁMICA (CONEXIÓN A SHEETS)
export async function generateMetadata(): Promise<Metadata> {
  // Buscamos la config del Admin por defecto para la Home
...
export default function RootLayout({
  ...
  return (
    <html lang="es" translate="no">
      <head>
        {/* 🔥 GOOGLE SEARCH CONSOLE - RECUPERADO */}
        <meta
          name="google-site-verification"
          content="c43EWcKPaKQuTZ0w9M0U0iLPzJEgoEQmVTxKVhzfn8I"
        />

        {/* SEO BASE & IPHONE FIXES - RECUPERADO */}
        <link rel="manifest" href="/manifest.json" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />

        {/* OG FIX MANUAL (WhatsApp / Facebook / etc) - RECUPERADO */}
        ...
        {/* 🔥 GOOGLE ANALYTICS SCRIPTS - RECUPERADO SIN CAMBIOS */}
        <Script
      ...
      <body className={`font-sans ${GeistSans.variable} ${GeistMono.variable} antialiased`}>
        ...
        {/* Fix de Vercel: Header envuelto en Suspense por useSearchParams */}
