...
const Check = () => <CheckCircle className="text-green-600 mx-auto" size={18} />
const Cross = () => <XCircle className="text-red-500 mx-auto" size={18} />
      ...
      <div className="overflow-x-auto mb-16">
        <table className="w-full text-sm border rounded-xl overflow-hidden">
          ...
          <tbody className="divide-y">
            ...
            {/* GRATIS */}
            <tr>
              <td className="p-4 text-left font-semibold">Plan gratuito</td>
            ...
            {/* MIGRAR */}
            <tr>
              <td className="p-4 text-left font-semibold">Podés migrar / es tuya</td>
              <td className="text-center"><Check /></td>
              <td className="text-center"><Cross /></td>
              <td className="text-center"><Cross /></td>
              <td className="text-center"><Cross /></td>
            ...
            {/* COSTO */}
            <tr>
              <td className="p-4 text-left font-semibold">Costo mensual</td>
              <td className="font-bold text-green-600 text-center">Sin costo</td>
            ...
            {/* COMISION */}
            <tr>
              <td className="p-4 text-left font-semibold">Comisión por venta</td>
              <td className="font-bold text-green-600 text-center">0%</td>
              <td className="text-center">2% + apps</td>
              <td className="text-center">1% - 2% + pagos</td>
              <td className="text-center">0% (pero limitado)</td>
              <td className="text-red-500 font-bold text-center">Hasta 17%</td>
              <td className="text-center"><Cross /></td>
            </tr>

            {/* DISEÑO */}
            <tr>
              <td className="p-4 text-left font-semibold">Diseño profesional real</td>
              <td className="text-center"><Check /></td>
              <td className="text-center"><Check /></td>
              <td className="text-center"><Cross /></td>
              <td className="text-center"><Cross /></td>
