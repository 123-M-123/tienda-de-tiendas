...
export default function HeroSection() {
  ...
  return (
    <section id="inicio" className="min-h-screen flex flex-col items-center bg-black text-white px-6 py-16">
      ...
      {/* CONTENEDOR PRINCIPAL: TEXTO + CARRUSEL VERTICAL */}
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div className="text-left space-y-6 order-2 lg:order-1">
          <h1 className="text-5xl md:text-7xl font-extrabold leading-tight tracking-tighter">
            TU TIENDA <br />
            <span className="text-red-600 uppercase">PROPIA.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a href="#contacto" className="bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full text-lg font-bold transition-all transform hover:scale-105 text-center">
              EMPEZAR AHORA
            </a>
        ...
        <div className="relative group order-1 lg:order-2 w-full max-w-112.5x-auto">
          <div className="relative aspect-4/5 overflow-hidden rounded-2xl border border-white/10 shadow-2xl shadow-red-900/40 bg-neutral-900">
            ...
            <button onClick={nextSlide} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/50 text-white opacity-0 group-hover:opacity-100 transition-opacity border border-white/10 hover:bg-red-600">
          ...
          <div className="flex justify-center gap-3 mt-6">
            {images.map((_, index) => (
              <button key={index} onClick={() => goToSlide(index)} className={`transition-all duration-300 ${index === currentIndex ? "w-8 h-2 bg-red-600 rounded-full" : "w-2 h-2 bg-white/30 rounded-full"}`} />
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-16 max-w-5xl w-full">
        <div className="border border-white/10 rounded-xl p-6 bg-white/5">
          <div className="flex justify-center mb-4 text-red-600"><Palette size={32} /></div>
        ...
        <div className="border border-white/10 rounded-xl p-6 bg-white/5">
          <div className="flex justify-center mb-4 text-red-600"><Unlock size={32} /></div>
        ...
        <div className="border border-white/10 rounded-xl p-6 bg-white/5">
          <div className="flex justify-center mb-4 text-red-600"><Banknote size={32} /></div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16 max-w-5xl w-full text-left">
        ...
        <div className="border border-red-900/30 rounded-xl p-8 bg-red-900/10 text-gray-400">
          <div className="flex items-center gap-3 mb-4"><XCircle size={24} className="text-red-500" /><h2 className="font-bold text-xl">Otras plataformas</h2></div>
